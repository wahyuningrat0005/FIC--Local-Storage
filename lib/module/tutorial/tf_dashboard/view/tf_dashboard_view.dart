...
class TfDashboardView extends StatefulWidget {
  const TfDashboardView({Key? key}) : super(key: key);

  Widget build(context, TfDashboardController controller) {
    controller.view = this;

    return Scaffold(
      appBar: AppBar(
        title: const Text("TfDashboard"),
        actions: const [],
      ),
  ...
  @override
  State<TfDashboardView> createState() => TfDashboardController();
}
